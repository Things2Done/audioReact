...
import { star, tree } from './addMeshes'
...
function animate() {
  ...
  meshes.star.rotation.z += .01
  // meshes.star.rotation.x += .01
//  meshes.star.position.x = data/5 - !tick

  // meshes.star.rotation.z += Math.cos(data)
